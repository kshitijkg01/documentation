...
your code. Bears analyze the source code provided by coala.
...
`here <http://api.coala.io/en/latest/Developers/Writing_Native_Bears.html>`__.

For more about different bears and languages each support
